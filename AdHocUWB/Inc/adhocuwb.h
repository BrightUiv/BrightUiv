...
//#define UWB_RANGING_ROUTING_ENABLE
//#define UWB_ROUTING_ENABLE
//#define UWB_RAFT_ENABLE
//#define UWB_FLOODING_ENABLE
//#define UWB_TEST_ENABLE

/* Conflict handle */
#ifdef UWB_RANGING_ENABLE // 默认如果你不小心两个ranging都开的话，就使用纯swarm ranging
  #undef UWB_RANGING_ROUTING_ENABLE
  #undef UWB_ROUTING_ENABLE
#endif

#ifdef UWB_RANGING_ROUTING_ENABLE
  #undef UWB_RANGING_ENABLE
#endif
